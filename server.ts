...
import { query, getDatabaseProviderInfo } from './src/db/index';
import { seedDatabaseIfEmpty } from './src/db/seed';
import { getOrCreateUser, updateUserRole } from './src/db/users';
import { hashPassword, comparePassword, isBcryptHash } from './src/db/password';
import { requireAuth, optionalAuth, AuthRequest } from './src/middleware/auth';
import { Admin, Category, Seller, Customer, Product, Review, Order, CartItem, Address, OrderItem } from './src/types';
import { initialCustomers, initialAdmin, initialSellers } from './src/data/seedData';
